package com.example.myapplication.nls;
...
public class NLSProtectService extends Service {
    ...
    private void ensureCollectorRunning() {
        ComponentName collectorComponent = new ComponentName(this,NLS.class);
    ...
    private void toggleNotificationListenerService() {
        ComponentName thisComponent = new ComponentName(this, NLS.class);
